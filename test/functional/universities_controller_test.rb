...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { abbreviated_name: @university.abbreviated_name, name: @university.name, zipcode: @university.zipcode }
    end
  ...
  test "should update university" do
    put :update, id: @university, university: { abbreviated_name: @university.abbreviated_name, name: @university.name, zipcode: @university.zipcode }
    assert_redirected_to university_path(assigns(:university))
  end
