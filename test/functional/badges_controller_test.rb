...
class BadgesControllerTest < ActionController::TestCase
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post :create, badge: { description: @badge.description, name: @badge.name, priority: @badge.priority }
    end
  ...
  test "should update badge" do
    put :update, id: @badge, badge: { description: @badge.description, name: @badge.name, priority: @badge.priority }
    assert_redirected_to badge_path(assigns(:badge))
  end
